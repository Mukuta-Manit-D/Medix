...
<a href="https://www.python.org/downloads/release/python-3113/" alt="3.11.3">
...
- **Cloud Storage** - The Database used to Manage the data of the Medix is MongoDB Compass, a Cloud storage service. One of the advantage of such is that multiple users can manipulate data from different places simutaneously.
